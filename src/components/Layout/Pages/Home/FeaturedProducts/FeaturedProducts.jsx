...
import FeaturedShimmer from "../../../../UI/Shimmer/FeaturedProductsSkeleton";
                ...
                {data.map((item) => (
                  <SwiperSlide key={item?.id}>
                    <Link to={`/shop/${item.id}`}>
                      <article className="featured-products__item-card cursor-pointer border border-[#ccc] shadow-sm p-2 rounded-md bg-slate-50 dark:bg-slate-700 dark:border-slate-500 transition-all duration-300 hover:-translate-y-1">
